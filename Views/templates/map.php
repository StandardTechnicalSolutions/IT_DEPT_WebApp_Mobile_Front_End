<?php 
    ...
    $placeholder3 = "<li><a href='/tss/exss/?location=home'>Home</a></li>";
    $placeholder4 = "<li><a href='/tss/exss/?location=equipment'>Equipment</a></li>";
    $placeholder5 = "<li><a href='/tss/exss/?location=map'>Map</a></li>";
    $placeholder6 = "<li><a href='/tss/exss/?location=contact'>Contact</a></li>";
    $placeholder7 = "<li><a href='/tss/exss/?location=orderForm'>Order Scantron</a></li>";
    $placeholder8 = "<li><a href='/tss/exss/?location=reporttype'>Report Type</a></li>";
